...
class SegList(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Follow the instruction: https://github.com/fyu/drn
        # The actual label maps should contain values in the range of [0, category_number).
        # In valid pixels can be labeled as 255 and they will be ignored in the training and evaluation
        # target = data[1]
...
def parse_args():
    ...
    parser.add_argument('-cmd', default='test', help='train or test')
    parser.add_argument('-d', '--data-dir', default='/media/samsumg_1tb/CITYSCAPE')
    ...
    parser.add_argument('--pretrained', dest='pretrained',
                        default='./pretrained/drn_d_38_cityscapes.pth', type=str, metavar='PATH',
